...
let iconTheme = "ri-sun-line"; // ri-menu-line
...
//웹스토어 값셋팅:
//localStirage.setItem(키:값)==>웹스토어에 값을 입력
//localStirage.getItem(키)==>웹스토어에 값을 가져올때
...
let scrollActive = () => {
  ...
  let sections = document.querySelectorAll("section[id]"); //section태그 중 속성 id가 있는 것
